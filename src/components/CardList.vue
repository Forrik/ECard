    ...
    <div v-if="cards.length > 0" class="wrapper_employee-card">
        ...
        <div class="card__table">
            <thead class="card__title">
                <td class="card__title__element">№
                    <svg  class="card__sort__icon" version="1.1" viewBox="0 0 401.998 401.998" style="enable-background:new 0 0 401.998 401.998;"
                        xml:space="preserve">
                        <g>
                            <g>
                                <path
                ...
                <td class="card__title__element">Имя
                    <svg  class="card__sort__icon" version="1.1" viewBox="0 0 401.998 401.998" style="enable-background:new 0 0 401.998 401.998;"
                        xml:space="preserve">
                        <g>
                            <g>
                ...
                <td class="card__title__element">Фамилия
                    <svg  class="card__sort__icon" version="1.1" viewBox="0 0 401.998 401.998" style="enable-background:new 0 0 401.998 401.998;"
                        xml:space="preserve">
                        <g>
                            <g>
                ...
                <td class="card__title__element">Отчество
                    <svg  class="card__sort__icon" version="1.1" viewBox="0 0 401.998 401.998" style="enable-background:new 0 0 401.998 401.998;"
                        xml:space="preserve">
                        <g>
                            <g>
                ...
                <td class="card__title__element">email 
                </td>
                <td class="card__title__element">Должность
                   
                </td>
            </thead>
            <transition-group name="list">
                <card-item v-for="card in cards" :card="card" :key="card.id" @remove="$emit('remove', card)" />
            </transition-group>
