<template>
    <div class="wrapper_employee-card">
        ...
        <tbody v-bind:key="card" v-for="card in cards" class="employee-card">
            ...
            <div class="card__icons">
                ...
                <svg  class="card__icon" viewBox="0 0 24 24" fill="none">
...
.employee-card:hover .card__icons{
    opacity: 1;
